...
const StartPage = (props)=> {
    ...
    useEffect(() => {
        dispatch({ type: 'currentMenuItems', name: 'currentMenuItems', value: ['start']});
    }, []);
    ...
    return (<Container p="md" h100> 
                <Row>
                    <Col offset={2} span={22}>
                        ...
                        <h3>Item Types</h3>
                        <Alert className="d-inline-flex" type="info" title="Create your own data types" showIcon/>
                        <div className="cards-container scrollable">{cards}</div>
                        <div>
                            <Link to="/dashboard/settings/types">
                                <Button type="primary">Go to the type editor</Button>
                            </Link>
                        </div>
                    </Col>
                </Row>
